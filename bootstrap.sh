...
sudo cp /vagrant/vagrant-deploy/apache2/site-local.conf /etc/apache2/sites-available
...
mysql -u root -ppass -e "create database collaborama;"
mysql -u root -ppass -e "create user 'collaborama'@'localhost' identified by 'pass';"
mysql -u root -ppass -e "grant all privileges on collaborama.* to 'collaborama'@'localhost';"
